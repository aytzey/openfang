//! Configuration loading from `~/.pulsivo-salesman/config.toml` with defaults.
//!
...
pub fn default_config_path() -> PathBuf {
    dirs::home_dir()
        ...
        .join(".pulsivo-salesman")
        .join("config.toml")
}

/// Get the default PulsivoSalesman home directory.
pub fn pulsivo_salesman_home() -> PathBuf {
    dirs::home_dir()
        .unwrap_or_else(std::env::temp_dir)
        .join(".pulsivo-salesman")
}
...
mod tests {
    ...
    fn test_deep_merge_simple() {
        ...
        assert_eq!(base["language"].as_str(), Some("tr"));
    }
