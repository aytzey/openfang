...
use pulsivo_salesman_types::tool::{ToolCall, ToolDefinition};
    ...
    fn reasoning_effort_label(request: &CompletionRequest) -> Option<&'static str> {
        request
            ...
            .map(|effort| match effort {
                pulsivo_salesman_types::agent::ReasoningEffort::Low => "low",
                pulsivo_salesman_types::agent::ReasoningEffort::Medium => "medium",
                pulsivo_salesman_types::agent::ReasoningEffort::High => "high",
            })
    }
