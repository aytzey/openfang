//! Shared error types for the PulsivoSalesman system.

use thiserror::Error;

/// Top-level error type for the PulsivoSalesman system.
#[derive(Error, Debug)]
pub enum PulsivoSalesmanError {
...
/// Alias for Result with PulsivoSalesmanError.
pub type PulsivoSalesmanResult<T> = Result<T, PulsivoSalesmanError>;
