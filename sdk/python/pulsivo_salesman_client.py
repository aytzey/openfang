"""
PulsivoSalesman Python Client — REST API client for controlling PulsivoSalesman remotely.
...
Note: This is the REST API *client* library.
      For writing Python agents that run inside PulsivoSalesman, see pulsivo_salesman_sdk.py instead.
"""
...
class PulsivoSalesman:
    """PulsivoSalesman REST API client. Zero dependencies — uses only stdlib urllib."""
